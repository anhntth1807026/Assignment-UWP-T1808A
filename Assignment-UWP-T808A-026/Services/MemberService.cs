...
namespace Assignment_UWP_T808A_026.Services
{
    class MemberService : IMemberService
    {
        public Member Register(Member member)
        {
            ...
            var response = httpClient.PostAsync(ProjectAPI.MEMBER_REGISTER_URL, content).GetAwaiter().GetResult();
        ...
        public MemberCredential Login(MemberLogin memberLogin)
        {
            ...
            var content = new StringContent(dataToSend, Encoding.UTF8, "application/json");
            var response = httpClient.PostAsync(ProjectAPI.MEMBER_LOGIN_URL, content).GetAwaiter().GetResult();
        ...
        public Member GetInformation(string token)
        {
            ...
            var response = httpClient.GetAsync(ProjectAPI.MEMBER_GET_INFORMATION).GetAwaiter().GetResult();

...
{
    ("mymusic", typeof(MyMusic)),
    ("allmusic", typeof(AllMusic)),
    ("register", typeof(Authen.Register)),
    ("login", typeof(Authen.Login)),
    ("accountInfo", typeof(Authen.AccountInfo)),
};
        ...
        private void NavView_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            _pages.Add(("content", typeof(Authen.Login)));
        ...
        private void On_Navigated(object sender, NavigationEventArgs e)
        {
            ...
            if (ContentFrame.SourcePageType == typeof(SetUp))
            {
        ...
        {
            ProjectAPI.txtNavViewSearchBox = NavViewSearchBox.Text;
            AllMusic page = new AllMusic();
            page.LoadAllSongs();
        }
    }
}
